...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='guide_dog',
    ...
    self.parser.add_argument('--save_video', action='store_true', default=True)
    ...
    self.parser.add_argument('--direct_result_path', default='')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/mnt/new',
                             help='dir of dataset')
