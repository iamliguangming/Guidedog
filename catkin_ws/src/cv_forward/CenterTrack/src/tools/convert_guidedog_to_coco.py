...
DATA_PATH = '/mnt/new/guidedog/'
SPLITS = ['train_half', 'val_half']
VIDEO_SETS = {'train_half': range(21), 'val_half': range(21)}
...
cats = ["man", "fire_hydrant", "trash_can", "oak_tree", "stop_sign", "mailbox","stop_light"]

cat_ids = {"man":1, "fire_hydrant":2, "trash_can":2, "oak_tree":2, "stop_sign":2, "mailbox":2, "stop_light":3}

CAMERA_CALIB = np.array([[762.7249337622711, 0, 640.5, 0],
