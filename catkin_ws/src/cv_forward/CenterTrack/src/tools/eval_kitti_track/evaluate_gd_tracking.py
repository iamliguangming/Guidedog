...
if __name__ == "__main__":
    ...
    result_sha = "/home/zhuoyu/Documents/CIS-700/Guidedog/catkin_ws/src/cv_forward/CenterTrack/exp/tracking,ddd/default/results_kitti_tracking/result"
    print(result_sha)
    # split_version = sys.argv[2] if len(sys.argv) >= 3 else ''
    split_version = "val_half"
    mail = mailpy.Mail("")
