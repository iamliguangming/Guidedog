...
struct SocialActivities_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::spencer_social_relation_msgs::SocialActivity_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::spencer_social_relation_msgs::SocialActivity_<ContainerAllocator> >::other >  _elements_type;
