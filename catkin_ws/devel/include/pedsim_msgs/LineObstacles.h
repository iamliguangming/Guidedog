...
struct LineObstacles_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::pedsim_msgs::LineObstacle_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::pedsim_msgs::LineObstacle_<ContainerAllocator> >::other >  _obstacles_type;
