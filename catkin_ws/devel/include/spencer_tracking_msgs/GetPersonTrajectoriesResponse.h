...
struct GetPersonTrajectoriesResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::spencer_tracking_msgs::PersonTrajectory_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::spencer_tracking_msgs::PersonTrajectory_<ContainerAllocator> >::other >  _trajectories_type;
