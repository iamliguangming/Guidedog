...
namespace pedsim_simulator
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(PedsimSimulatorConfig &config, const PedsimSimulatorConfig &max, const PedsimSimulatorConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const PedsimSimulatorConfig &config1, const PedsimSimulatorConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, PedsimSimulatorConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const PedsimSimulatorConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, PedsimSimulatorConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const PedsimSimulatorConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const PedsimSimulatorConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, PedsimSimulatorConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
